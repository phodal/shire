...
class ShireRunner(
    ...
    fun prepareExecute(parsedResult: ShireParsedResult) {
        ...
        val context = ShireRunContext.getData() ?: ShireRunContext(
            ...
            ShireRunContext.updateContextAndVariables(it)
        }
